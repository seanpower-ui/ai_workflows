...
export default function CreatingPrdsPage() {
  return (
    <GuidePageContent
      steps={[
        {
          title: "Step 1: Define scope and objectives",
          description: "",
          content: (
            <div className={slideClass}>
              <span className="text-lg">Step 1: Define scope and objectives</span>
            </div>
          ),
        },
        {
          title: "Step 2: Outline requirements and acceptance criteria",
          description: "",
          content: (
            <div className={slideClass}>
              <span className="text-lg">
                Step 2: Outline requirements and acceptance criteria
              </span>
            </div>
          ),
        },
        {
          title: "Step 3: Review and iterate with your agent",
          description: "",
          content: (
            <div className={slideClass}>
              <span className="text-lg">Step 3: Review and iterate with your agent</span>
            </div>
          ),
        },
        {
