...
export default function SetupGithubPage() {
  return (
    <GuidePageContent
      steps={[
        {
          title: "Step 1: Clone or create your repository",
          description: "",
          content: (
            <div className={slideClass}>
              <span className="text-lg">Step 1: Clone or create your repository</span>
            </div>
          ),
        },
        {
          title: "Step 2: Configure branches and access",
          description: "",
          content: (
            <div className={slideClass}>
              <span className="text-lg">Step 2: Configure branches and access</span>
            </div>
          ),
        },
        {
          title: "Step 3: Set up CI/CD and workflows",
          description: "",
          content: (
            <div className={slideClass}>
              <span className="text-lg">Step 3: Set up CI/CD and workflows</span>
            </div>
          ),
        },
        {
